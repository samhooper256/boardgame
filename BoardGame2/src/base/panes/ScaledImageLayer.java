...
/**<p>{@link ScaledImageLayer ScaledImageLayers} allow for {@link ImagePane ImagePanes} to be properly displayed on the
...
public interface ScaledImageLayer extends Updatable {
	...
	/** @throws IllegalStateException if the given {@link ImagePane} is not in this {@link ScaledImageLayer}. */
